class DoTheDb < ActiveRecord::Migration
  def change
    excute "CREATE TABLE categories
(
...
INSERT INTO sous_categories VALUES(default,'Housses de couette',1,0);
INSERT INTO sous_categories VALUES(default,'Lampes de table',2,0);
INSERT INTO sous_categories VALUES(default,'Suspensions',2,0);
INSERT INTO sous_categories VALUES(default,'Gardes-robes',3,0);
INSERT INTO sous_categories VALUES(default,'Lits',3,0);
INSERT INTO sous_categories VALUES(default,'Tringles à vêtements',4,0);
INSERT INTO sous_categories VALUES(default,'Etagères',4,0);
INSERT INTO sous_categories VALUES(default,'Portes de colonne',4,0);
...
(
	...
	prod_fk_sous_categories integer REFERENCES sous_categories(sscat_id)	
);

INSERT INTO produits VALUES(default,'Lonn','lonn_v.jpg','lonn_i.jpg','100% coton','<B>Housse en 100% coton.</B><BR>Plusieurs coloris.<BR>Design : B. Peterson<BR>',0,1);
INSERT INTO produits VALUES(default,'Kare','kare_v.jpg','kare_i.jpg','Acier laqué et verre','<B>lampe de table en acier laqué et verre soufflé à la bouche.</B><BR>Diamètre : 16 cm.<BR>Hauteur : 28 cm.<BR>Max 40 W ou ampoule économique de 6 W.<BR>',0,2);
INSERT INTO produits VALUES(default,'Porfylit','porfylit_v.jpg','porfylit_i.jpg','Bouleau','<B>Lampe de table en bouleau verni avec abat-jour en verre opalin soufflé à la bouche</B><BR>Diamètre : 12 cm.<BR>Hauteur : 25 cm.<BR>Max 40 W ou ampoule économique de 7 W.<BR>',0,2);
INSERT INTO produits VALUES(default,'Takter','takter_v.jpg','takter_i.jpg','Aluminium','<B>Suspension en alluminium laqué.</B><BR>Hauteur réglable.<BR>Diamètre : 30 cm.<BR>Hauteur : 35 cm.<BR>Max 75 W ou ampoule économique de 15 W.<BR>',0,3);
INSERT INTO produits VALUES(default,'Pax Nexus','pax_v.gif','pax_i.jpg','Colonne','<B>Elément de base de la colonne.</B><BR>Panneau de particules de 18 cm d''épaisseur.<BR>',0,4);
INSERT INTO produits VALUES(default,'Morkedal','morkedal_v.gif','morkedal_i.jpg','Lit','<B>Structure en aggloméré renforcé, avec revêtement en tissu blanc ou lilas et piétement en métal.</B><BR>La tête est conçue pour offri un bon soutien dorsal lorsque vous lisez.<BR>ce lit se marie bien avec des meubles en hêtre ou en bouleau.<BR>',0,5);
INSERT INTO produits VALUES(default,'Komplement','komplement_v.jpg','komplement_i.jpg','Acier laqué','<B>Tringle à vêtements en acier laqué gris, pour gardes-robes Pax et Askedal</B><BR>Disponible en différentes largeur.<BR>',0,6);
INSERT INTO produits VALUES(default,'Pax Stag','pax_stag_v.jpg','pax_stag_i.jpg','Etagères pour colonne','<B>Etagères (par 2 pièces) pour gardes-robes Pax</B><BR>Disponible en hêtre ou en bouleau et en différentes largeur.<BR>',0,7);
INSERT INTO produits VALUES(default,'Pax Drammen','pax_dra_v.jpg','pax_dra_i.jpg','Porte pour colonne','<B>Portes en verre trempé et cadre en aluminium pour les gardes-robes Pax</B><BR>Disponible en différentes largeur.<BR>Charnières incluses.<BR>',0,8);
...
INSERT INTO proprietes VALUES(default,'Dimensions');
INSERT INTO proprietes VALUES(default,'Non personnalisable');
INSERT INTO proprietes VALUES(default,'Largeur');
INSERT INTO proprietes VALUES(default,'Hauteur');
INSERT INTO proprietes VALUES(default,'Profondeur');
INSERT INTO proprietes VALUES(default,'Revêtement');

CREATE TABLE caracteristiques
(
	car_id        		serial PRIMARY KEY,
	car_fk_produits       	integer NOT NULL REFERENCES produits(prod_id),
	car_fk_proprietes     	smallint NOT NULL REFERENCES proprietes(prop_id),
	car_valeur    		varchar(20)
);

INSERT INTO caracteristiques VALUES(default,1,1,'150x210');
INSERT INTO caracteristiques VALUES(default,1,1,'200x200');
INSERT INTO caracteristiques VALUES(default,1,1,'240x220');
INSERT INTO caracteristiques VALUES(default,2,2,NULL);
INSERT INTO caracteristiques VALUES(default,3,2,NULL);
INSERT INTO caracteristiques VALUES(default,4,2,NULL);
INSERT INTO caracteristiques VALUES(default,5,3,'50 cm');
INSERT INTO caracteristiques VALUES(default,5,3,'100 cm');
INSERT INTO caracteristiques VALUES(default,5,4,'201 cm');
INSERT INTO caracteristiques VALUES(default,5,4,'236 cm');
INSERT INTO caracteristiques VALUES(default,5,5,'60 cm');
INSERT INTO caracteristiques VALUES(default,5,5,'37 cm');
INSERT INTO caracteristiques VALUES(default,5,6,'Bouleau');
INSERT INTO caracteristiques VALUES(default,5,6,'Hêtre');
INSERT INTO caracteristiques VALUES(default,6,1,'167x210 cm');
INSERT INTO caracteristiques VALUES(default,6,1,'187x210 cm');
INSERT INTO caracteristiques VALUES(default,6,6,'Blanc');
INSERT INTO caracteristiques VALUES(default,6,6,'Lilas');
INSERT INTO caracteristiques VALUES(default,7,3,'50 cm'); 
INSERT INTO caracteristiques VALUES(default,7,3,'100 cm'); 	
INSERT INTO caracteristiques VALUES(default,8,3,'50 cm');   
INSERT INTO caracteristiques VALUES(default,8,3,'100 cm'); 	
INSERT INTO caracteristiques VALUES(default,8,5,'60 cm');   
INSERT INTO caracteristiques VALUES(default,8,5,'37 cm');	
INSERT INTO caracteristiques VALUES(default,8,6,'Bouleau'); 
INSERT INTO caracteristiques VALUES(default,8,6,'Hêtre');
INSERT INTO caracteristiques VALUES(default,9,3,'50 cm');
INSERT INTO caracteristiques VALUES(default,9,3,'100 cm');
INSERT INTO caracteristiques VALUES(default,9,4,'201 cm');
INSERT INTO caracteristiques VALUES(default,9,4,'236 cm');
...
INSERT INTO prix VALUES(default,32.375,0.9,0.1);
INSERT INTO prix VALUES(default,39.875,1.2,0.15);
INSERT INTO prix VALUES(default,49.875,1.4,0.2);
INSERT INTO prix VALUES(default,32.375,1.5,0.2);
INSERT INTO prix VALUES(default,19.875,1.2,0.15);
INSERT INTO prix VALUES(default,49.875,1.8,0.35);

INSERT INTO prix VALUES(default,150,40,1);
INSERT INTO prix VALUES(default,187.375,50,1.5);
INSERT INTO prix VALUES(default,134.875,30,0.8);
INSERT INTO prix VALUES(default,179.875,40,1.2);
INSERT INTO prix VALUES(default,244.875,50,1.8);
INSERT INTO prix VALUES(default,309.925,60,2.1);
INSERT INTO prix VALUES(default,237.375,40,1.5);
INSERT INTO prix VALUES(default,302.375,50,1.7);
...
INSERT INTO prix VALUES(default,374.875,80,2.7);
INSERT INTO prix VALUES(default,399.875,85,2.8);

INSERT INTO prix VALUES(default,374.875,80,2.7);
INSERT INTO prix VALUES(default,399.875,85,2.8);

INSERT INTO prix VALUES(default,5,0.2,0.4);
INSERT INTO prix VALUES(default,5.675,0.25,0.45);

INSERT INTO prix VALUES(default,12.5,0.5,0.5);
INSERT INTO prix VALUES(default,11.25,0.45,0.45);
INSERT INTO prix VALUES(default,18.75,0.7,0.7);
INSERT INTO prix VALUES(default,15,0.65,0.65);
...
INSERT INTO prix VALUES(default,138.75,12.5,1.65);
INSERT INTO prix VALUES(default,172.375,13.5,1.85);
INSERT INTO prix VALUES(default,222.375,20.5,2.65);
INSERT INTO prix VALUES(default,279.875,23.5,2.85);

CREATE TABLE identifiant_combi
(
	idc_id		serial PRIMARY KEY,
	idc_fk_prix	integer NOT NULL REFERENCES prix(pri_id)
);
...
(
	com_fk_caracteristiques     integer NOT NULL REFERENCES caracteristiques(car_id),
...
(
	rel_fk_produits_princ 	integer NOT NULL REFERENCES produits(prod_id),
	rel_fk_produits_sec   	integer NOT NULL REFERENCES produits(prod_id)
);

CREATE UNIQUE INDEX index_relations ON relations
(
	rel_fk_produits_princ ASC,
	rel_fk_produits_sec ASC
);
...
CREATE TABLE pays
(
        pays_abreviation        varchar(2) PRIMARY KEY,
        pays_nom                varchar(20),
        pays_port               decimal(5,2)
);

INSERT INTO pays VALUES('B','Belgique',275);
INSERT INTO pays VALUES('F','France',675);
INSERT INTO pays VALUES('I','Italie',875);
INSERT INTO pays VALUES('NE','Hollande',575);
...
(
	...
	cli_fk_pays      	varchar(2) NOT NULL REFERENCES pays(pays_abreviation),
...
(
	lig_id        		serial PRIMARY KEY,
	lig_fk_commandes    integer NOT NULL REFERENCES commandes(com_id),
	lig_fk_identifiant_combi       	integer NOT NULL REFERENCES identifiant_combi(idc_id),
	lig_quantite  		smallint NOT NULL
);
